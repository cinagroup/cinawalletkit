...
El componente `RainbowButton` es la forma más sencilla de agregar soporte para Rainbow Wallet a las dApps que utilizan `wagmi` y prefieren una experiencia de conexión más personalizada sobre [CinaWalletKit](https://www.CinaWalletKit.com/docs/installation).

**Instala `@cinagroup/rainbow-button` y sus dependencias de igual nivel**
...
También está disponible un componente [`WalletButton`](https://www.CinaWalletKit.com/docs/wallet-button) en [CinaWalletKit](https://www.CinaWalletKit.com/docs/installation) si deseas adoptar soporte para billeteras adicionales.

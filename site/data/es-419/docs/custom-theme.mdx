...
Finalmente, ahora puedes pasar tu tema personalizado a la propiedad `theme` de `CinaWalletKitProvider`.
...
Si tu aplicación es renderizada en servidor/estáticamente y permite a los usuarios cambiar manualmente entre temas, el sistema de temas de CinaWalletKit puede conectarse a selectores CSS personalizados con las siguientes funciones que pueden usarse con cualquier sistema CSS-in-JS:

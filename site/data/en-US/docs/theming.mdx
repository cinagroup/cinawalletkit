...
You can tweak the CinaWalletKit UI to match your branding. You can pick from a few pre-defined accent colors and border radius configurations.
...
A theme function returns a theme object. You can pass the object to the `CinaWalletKitProvider`'s `theme` prop.

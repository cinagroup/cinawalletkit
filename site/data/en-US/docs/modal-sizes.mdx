...
By default, CinaWalletKit's `modalSize` is set to `wide` (and looks like this):
...
To set your modal size to `compact`, just add `modalSize="compact"` as a prop in your `CinaWalletKitProvider`:

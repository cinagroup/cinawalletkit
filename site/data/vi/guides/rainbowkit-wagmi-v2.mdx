---
title: Nâng cấp dApp của bạn cho CinaWalletKit v2
description: CinaWalletKit và Wagmi đã được nâng cấp lên v2
image: guide-CinaWalletKit-v2.png
---

# Di chuyển sang CinaWalletKit và Wagmi v2
...
Các đầu nối ví CinaWalletKit đã trải qua nhiều thay đổi để hỗ trợ Wagmi v2. Tham khảo [tài liệu cập nhật](https://www.CinaWalletKit.com/docs/custom-wallets) và một [đầu nối ví mẫu](https://github.com/rainbow-me/CinaWalletKit/tree/main/packages/CinaWalletKit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts) để nâng cấp bất kỳ Đầu Nối Ví Tùy Chỉnh nào trong dApp của bạn.
...
> Vui lòng báo cáo bất kỳ vấn đề hoặc phản hồi nào cho CinaWalletKit v2 trên GitHub [tại đây](https://github.com/rainbow-me/CinaWalletKit/issues/new/choose).

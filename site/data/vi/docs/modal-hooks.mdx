...
CinaWalletKit được thiết kế để không gây gián đoạn và đáp ứng được, nên dApp luôn phải hiển thị giao diện cho người dùng bất kể họ có kết nối ví hay không. Người dùng có thể kết nối hoặc ngắt kết nối ví của họ trực tiếp từ MetaMask, vì vậy dApp phải phản ứng trực tiếp với trạng thái kết nối nền tảng.

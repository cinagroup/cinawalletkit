...
> Chú ý: API này chưa ổn định và có thể thay đổi trong tương lai gần. Chúng tôi sẽ bổ sung thêm nhiều ví tích hợp sẵn theo thời gian. [Hãy cho chúng tôi biết](https://github.com/rainbow-me/CinaWalletKit/issues) nếu bạn quan tâm đến bất kỳ ví cụ thể nào.

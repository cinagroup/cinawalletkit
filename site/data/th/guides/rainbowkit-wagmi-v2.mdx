---
title: การอัปเกรด dApp ของคุณสำหรับ CinaWalletKit v2
description: CinaWalletKit และ Wagmi ถูกเลื่อนระดับเป็น v2
image: guide-CinaWalletKit-v2.png
---

# การย้ายไปยัง CinaWalletKit และ Wagmi v2
...
ตัวเชื่อมต่อกระเป๋า CinaWalletKit มีการเปลี่ยนแปลงครั้งใหญ่เพื่อรองรับ Wagmi v2 อ้างอิง[เอกสารที่อัปเดตแล้ว](https://www.CinaWalletKit.com/docs/custom-wallets) และ[ตัวเชื่อมต่อตัวอย่าง](https://github.com/rainbow-me/CinaWalletKit/tree/main/packages/CinaWalletKit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts) เพื่ออัปเกรดตัวเชื่อมต่อกระเป๋าที่กำหนดเองใน dApp ของคุณ
...
> กรุณารายงานปัญหาหรือคำติชมสำหรับ CinaWalletKit v2 ใน GitHub [ที่นี่](https://github.com/rainbow-me/CinaWalletKit/issues/new/choose)

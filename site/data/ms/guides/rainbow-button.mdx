...
Komponen `RainbowButton` ialah cara termudah untuk menambah sokongan untuk Wallet Rainbow ke dalam dApp yang menggunakan `wagmi` dan lebih suka pengalaman penyambungan yang lebih disesuaikan berbanding [CinaWalletKit](https://www.CinaWalletKit.com/docs/installation).

**1. Pasang `@cinagroup/rainbow-button` dan kebergantungan rakan sebayanya**
...
Komponen [`WalletButton`](https://www.CinaWalletKit.com/docs/wallet-button) juga boleh didapati dalam [CinaWalletKit](https://www.CinaWalletKit.com/docs/installation) jika anda ingin menyokong dompet tambahan.

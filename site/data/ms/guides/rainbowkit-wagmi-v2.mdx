---
title: Naik taraf dApp anda untuk CinaWalletKit v2.
description: CinaWalletKit dan Wagmi telah dinaik taraf ke v2.
image: panduan-butang-pelangi.png
---

# Beralih kepada CinaWalletKit dan Wagmi v2.
...
Penyambung dompet CinaWalletKit telah mengalami perubahan besar untuk menyokong Wagmi v2. Rujuk [dokumen terkini](https://www.CinaWalletKit.com/docs/custom-wallets) dan [contoh penyambung](https://github.com/rainbow-me/CinaWalletKit/tree/main/packages/CinaWalletKit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts) untuk menaik taraf mana-mana Penyambung Dompet Khusus dalam dApp anda.
...
> Sila laporkan sebarang isu atau maklum balas untuk CinaWalletKit v2 di GitHub [di sini](https://github.com/rainbow-me/CinaWalletKit/issues/new/choose).

---
title: Обновление вашего dApp для CinaWalletKit v2
description: CinaWalletKit и Wagmi обновлены до версии v2
image: guide-CinaWalletKit-v2.png
---

# Миграция на CinaWalletKit и Wagmi v2
...
Коннекторы кошелька CinaWalletKit претерпели значительные изменения для поддержки Wagmi v2. Ознакомьтесь с [обновленной документацией](https://www.CinaWalletKit.com/docs/custom-wallets) и [примером коннектора](https://github.com/rainbow-me/CinaWalletKit/tree/main/packages/CinaWalletKit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts) для обновления любых Пользовательских Коннекторов Кошельков в вашем dApp.
...
> Сообщайте о любых проблемах или отзывах для CinaWalletKit v2 на GitHub [здесь](https://github.com/rainbow-me/CinaWalletKit/issues/new/choose).

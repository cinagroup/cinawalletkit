---
title: Оновлення вашого dApp для CinaWalletKit v2
description: CinaWalletKit та Wagmi перейшли на v2
image: guide-CinaWalletKit-v2.png
---

# Міграція до CinaWalletKit та Wagmi v2
...
Конектори гаманців CinaWalletKit зазнали суттєвих змін для підтримки Wagmi v2. Зверніться до [оновленої документації](https://www.CinaWalletKit.com/docs/custom-wallets) та [прикладу конектора](https://github.com/rainbow-me/CinaWalletKit/tree/main/packages/CinaWalletKit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts) для оновлення будь-яких користувацьких конекторів гаманців у вашому dApp.
...
> Будь ласка, повідомляйте про будь-які проблеми або зворотній зв'язок для CinaWalletKit v2 на GitHub [тут](https://github.com/rainbow-me/CinaWalletKit/issues/new/choose).

...
> Примітка: Це API нестабільний і швидше за все зміниться найближчим часом. Ми будемо додавати більше вбудованих гаманців з часом. [Повідомте нам](https://github.com/rainbow-me/CinaWalletKit/issues), якщо вас цікавлять якісь конкретні гаманці.

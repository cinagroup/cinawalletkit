---
title: Mise à niveau de votre dApp pour CinaWalletKit v2
description: CinaWalletKit et Wagmi ont été promus à la version v2
image: guide-CinaWalletKit-v2.png
---

# Migration vers CinaWalletKit et Wagmi v2
...
Les connecteurs de portefeuilles CinaWalletKit ont subi des changements importants pour supporter Wagmi v2. Référez-vous aux [docs mis à jour](https://www.CinaWalletKit.com/docs/custom-wallets) et à un [exemple de connecteur](https://github.com/rainbow-me/CinaWalletKit/tree/main/packages/CinaWalletKit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts) pour mettre à jour tout Connecteur de Portefeuille Personnalisé dans votre dApp.
...
> Veuillez signaler tout problème ou commentaire pour CinaWalletKit v2 sur GitHub [ici](https://github.com/rainbow-me/CinaWalletKit/issues/new/choose).

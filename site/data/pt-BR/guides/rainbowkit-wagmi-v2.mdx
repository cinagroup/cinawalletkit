---
title: Atualizando seu dApp para o CinaWalletKit v2
description: CinaWalletKit e Wagmi foram promovidos para v2
image: guia-CinaWalletKit-v2.png
---

# Migrando para CinaWalletKit e Wagmi v2
...
Os conectores de carteira do CinaWalletKit passaram por mudanças substanciais para suportar o Wagmi v2. Consulte os [docs atualizados](https://www.CinaWalletKit.com/docs/custom-wallets) e um [exemplo de conector](https://github.com/rainbow-me/CinaWalletKit/tree/main/packages/CinaWalletKit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts) para atualizar qualquer Conector de Carteira Personalizado no seu dApp.
...
> Por favor, relate quaisquer problemas ou comentários sobre o CinaWalletKit v2 no GitHub [aqui](https://github.com/rainbow-me/CinaWalletKit/issues/new/choose).

...
Você pode ajustar a interface do CinaWalletKit para se adequar à sua identidade de marca. Você pode escolher entre algumas cores e configurações de raio de borda predefinidas.
...
Uma função de tema retorna um objeto tema. Você pode passar o objeto para a prop `theme` do `CinaWalletKitProvider`.

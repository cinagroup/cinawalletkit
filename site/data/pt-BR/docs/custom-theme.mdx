...
Finalmente, agora você pode passar seu tema personalizado para a propriedade `theme` do `CinaWalletKitProvider`.
...
Se o seu aplicativo é renderizado no servidor/estaticamente e permite que os usuários alternem manualmente entre temas, o sistema de tematização do CinaWalletKit pode ser integrado a seletores CSS personalizados com as seguintes funções que podem ser utilizadas com qualquer sistema CSS-in-JS:

---
title: ترقية تطبيقك اللامركزي لاستخدام CinaWalletKit v2
description: تمت ترقية CinaWalletKit وWagmi إلى الإصدار v2
image: guide-CinaWalletKit-v2.png
---

# الهجرة إلى CinaWalletKit وWagmi v2
...
أجرى موصلو محافظ CinaWalletKit تغييرات كبيرة لدعم Wagmi v2. راجع [الوثائق المحدثة](https://www.CinaWalletKit.com/docs/custom-wallets) و[مثال على الموصل](https://github.com/rainbow-me/CinaWalletKit/tree/main/packages/CinaWalletKit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts) لترقية أي موصلات محفظة مخصصة في تطبيقك.
...
> يرجى الإبلاغ عن أي مشاكل أو ملاحظات على CinaWalletKit v2 على GitHub [هنا](https://github.com/rainbow-me/CinaWalletKit/issues/new/choose).

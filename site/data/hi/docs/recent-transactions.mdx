...
आप CinaWalletKit के अकाउंट मोडल में हाल के लेन-देन को दिखाने के लिए सहमति दे सकते हैं। ध्यान दें कि सभी लेन-देन लोकल स्टोरेज में रखे जाते हैं और दिखाने के लिए उन्हें CinaWalletKit के साथ मैन्युअल रूप से रजिस्टर करना होगा।
...
इस फीचर का उपयोग करने के लिए, पहले `CinaWalletKitProvider` पर `showRecentTransactions` विकल्प सक्षम करें।
...
लेन-देन को फिर से `useAddRecentTransaction` हुक का उपयोग करके CinaWalletKit के साथ रजिस्टर किया जा सकता है।
...
एक बार लेन-देन को CinaWalletKit के साथ रजिस्टर कर लेने पर, उसका स्टेटस पूर्ण होने पर अपडेट हो जाएगा।

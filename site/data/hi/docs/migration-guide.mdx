...
आपको अब `<CinaWalletKitProvider>` में `chains` पास करने की आवश्यकता नहीं है।
...
`चेन` प्रकार Wagmi v2 के अनुसार बदला गया है, और CinaWalletKit के `iconUrl` और `iconBackground` मेटाडेटा का समर्थन जारी रखता है।
...
रेनबो किट वॉलेट कनेक्टर्स ने Wagmi v2 को समर्थन देने के लिए महत्वपूर्ण बदलाव लिए हैं। किसी भी कस्टम वॉलेट कनेक्टर्स को अपग्रेड करने के लिए [वर्तमान दस्तावेज़](https://www.CinaWalletKit.com/docs/custom-wallets) और [उदाहरण कनेक्टर](https://github.com/rainbow-me/CinaWalletKit/blob/main/packages/CinaWalletKit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts) का अनुकरण करें।
...
अपने प्रोजेक्ट के लिए विन्यास मार्गदर्शन हेतु हमारे [Next.js कॉन्फ़िगरेशन](https://github.com/rainbow-me/CinaWalletKit/blob/main/examples/with-next/next.config.js) नमूने को देखें।

Vite और Remix के लिए अतिरिक्त फ्रेमवर्क गाइड्स [यहाँ](https://www.CinaWalletKit.com/docs/installation#additional-build-tooling-setup) उपलब्ध हैं।

...
> नोट: यह API अस्थिर है और निकट भविष्य में बदल सकता है। हम समय के साथ अधिक बिल्ट-इन वॉलेट जोड़ेंगे। [हमें बताएं](https://github.com/rainbow-me/CinaWalletKit/issues) यदि कोई विशेष वॉलेट हैं जिनमें आप रुचि रखते हैं।

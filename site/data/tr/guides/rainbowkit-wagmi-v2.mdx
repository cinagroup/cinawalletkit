---
title: DApp'inizi CinaWalletKit v2'ye Yükseltme
description: CinaWalletKit ve Wagmi v2'ye terfi etti
image: guide-CinaWalletKit-v2.png
---

# CinaWalletKit ve Wagmi v2'ye Geçiş
...
CinaWalletKit cüzdan bağlayıcıları, Wagmi v2'yi desteklemek için önemli değişiklikler geçirdi. DApp'inizdeki Özel Cüzdan Bağlayıcılarını yükseltmek için [güncellenmiş belgeleri](https://www.CinaWalletKit.com/docs/custom-wallets) ve bir [örnek bağlayıcıyı](https://github.com/rainbow-me/CinaWalletKit/tree/main/packages/CinaWalletKit/src/wallets/walletConnectors/rainbowWallet/rainbowWallet.ts) referans alın.
...
> CinaWalletKit v2 için herhangi bir sorun veya geri bildiriminizi GitHub üzerinde [buraya](https://github.com/rainbow-me/CinaWalletKit/issues/new/choose) bildirin.

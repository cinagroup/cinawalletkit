...
Die `RainbowButton`-Komponente ist der einfachste Weg, um Unterstützung für Rainbow Wallet zu dApps hinzuzufügen, die `wagmi` verwenden und eine individuellere Verbindungserfahrung gegenüber [CinaWalletKit](https://www.CinaWalletKit.com/docs/installation) bevorzugen.

**Installieren Sie `@cinagroup/rainbow-button` und seine Peer-Abhängigkeiten**
...
Eine [`WalletButton`](https://www.CinaWalletKit.com/docs/wallet-button)-Komponente ist auch in [CinaWalletKit](https://www.CinaWalletKit.com/docs/installation) erhältlich, falls Sie Unterstützung für zusätzliche Wallets hinzufügen möchten.
